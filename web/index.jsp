 ...
 <div class="container">
    <div id="myCarousel" class="carousel" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="item">
          <img src="Image/logo.png" width="93%">
...
Today carpool has become need of the hour. This year seems to be the most happening year for carpool. carpool movement, especially in metros. Media is also playing an active role to strengthen this movement and also providing awareness to masses.
        ...
        <p><i class="fa fa-map-pin"></i> B-1/624, Najafgarh Road, Block B1, Janakpuri, Delhi 110058, INDIA</p>
      ...
      <div class="col-md-4 col-sm-4 paddingtop-bottom">
        <div class="fb-page" data-href="https://www.facebook.com/facebook" data-tabs="timeline" data-height="300" data-small-header="false" style="margin-bottom:15px;" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
          ...
          <div class="twitter-page" data-href="https://www.twitter.com/twitter" data-tabs="timeline" data-height="300" data-small-header="false" style="margin-bottom:15px;" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
          <div class="fb-xfbml-parse-ignore">
