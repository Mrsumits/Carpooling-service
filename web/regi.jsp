  ...
  <div class="container">
	<form class="well span8">
        <div class="row">
            <div class="span3">
                <label>Name</label>
                <input class="span3" placeholder="Name" type="text">
                <label>Address</label>
                <input class="span3" placeholder="Address" type="text">
                <label>Contact No.</label> 
                <input class="span3" placeholder="Contact No" type="text"> 
                <label>Date of Birth</label> 
                <input class="span3" placeholder="DOB" type="text">
                <label>State</label> 
                <input class="span3" placeholder="State" type="text">
            </div>
...
Today carpool has become need of the hour. This year seems to be the most happening year for carpool. carpool movement, especially in metros. Media is also playing an active role to strengthen this movement and also providing awareness to masses.
        ...
        <p><i class="fa fa-map-pin"></i> 1/624, Najafgarh Road, Block B1, Janakpuri, Delhi 110058, INDIA, INDIA</p>
